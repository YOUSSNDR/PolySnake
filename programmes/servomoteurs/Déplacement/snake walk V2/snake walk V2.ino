...
void loop() {
  ...
  */
  if(etat0==1 && nxtangle0==tet[0]){
    servo0.write(tet[0]);
    servo1.write(tet[1]);
    servo2.write(tet[2]);
    nxtangle0=tet[etat0];
    etat0=0;
    Serial.println("mouvement 1 fait");
    delay(1000);
  }
  else if(etat0==1 && nxtangle0==tet[2]){
    servo0.write(tet[2]);
    servo1.write(tet[1]);
    servo2.write(tet[0]);
    nxtangle0=tet[etat0];
    etat0=2;
    Serial.println("mouvement 2 fait");
    delay(1000);
  }
  else if (etat0=2 && nxtangle0==tet[1]){ //la condition sur nxtangle est inutile ici
    servo0.write(tet[1]);
    servo1.write(tet[2]);
    servo2.write(tet[1]);
    nxtangle0=tet[0];
    etat0=1;
    Serial.println("mouvement 3 fait");
    delay(1000);
  }
  else{
    servo0.write(tet[1]);
    ...
    nxtangle0=tet[2];
    etat0=1;
    Serial.println("mouvement 4 fait");
    delay(1000);
  } 
